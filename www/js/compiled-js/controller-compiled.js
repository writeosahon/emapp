...
utopiasoftware.emap.controller = {
    ...
    startup: function startup() {
        ...
        ons.ready(function () {
            ...
            if (utopiasoftware.emap.model.isAppReady === false) {
    ...
    tocPageViewModel: {
        ...
        pageInit: function pageInit(event) {
            ...
            function loadPageOnAppReady() {
                ...
                ej.grids.Grid.Inject(ej.grids.Page, ej.grids.Selection, ej.grids.Scroll, ej.grids.Search, ej.grids.Toolbar, ej.grids.DetailRow, ej.grids.PdfExport, ej.grids.ExcelExport, ej.grids.Group, ej.grids.Aggregate);
